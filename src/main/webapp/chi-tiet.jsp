...
<form action="/sinh-vien/update" method="post">
    <div class="mb-3">
        ...
        <input type="text" class="form-control" name="maSinhVien" value="${sinhVienDetail.maSv}">
    </div>
    <div class="mb-3">
        <label class="form-label">Ten sinh vien</label>
        <input type="text" class="form-control" name="tenSinhVien" value="${sinhVienDetail.tenSv}">
    </div>
    <div class="mb-3">
        <label class="form-label">Tuoi</label>
        <input type="text" class="form-control" name="tuoi" value="${sinhVienDetail.tuoi}">
    </div>
    <div class="mb-3">
        <label class="form-label">Dia Chi</label>
        <input type="text" class="form-control" name="diaChi" value="${sinhVienDetail.diaChi}">
    </div>
    <div class="mb-3">
